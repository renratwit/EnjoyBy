...
public class Shopping_List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button goToMain = (Button) findViewById(R.id.goMainButton);
        goToMain.setOnClickListener(new View.OnClickListener(){

            @Override
            public void onClick(View v) {
                Intent goToMainIntent = new Intent();
                goToMainIntent.setClass(Shopping_List.this, MainActivity.class);
    ...
    private void clearDialog() {
        ...
        alert.setMessage("Are you sure you want to delete the list ?");
    ...
    private void addDialog() {
        ...
        text.setHint(R.string.addOne_note);
    ...
    private void modifyOne(final int position) {
        ...
        mComment = (Comment) mTweets.get(position);
    ...
    private void refreshList() {
        ShoppingFoodListAdapter adapter = new ShoppingFoodListAdapter(Shopping_List.this, mTweets);
